 ...
 *
 * NOTE: this is view-level separation in the client, matching the trust model
 * of the shared-password CRM it replaces — it is not hard security. Real
 * enforcement (Supabase Auth + RLS, Microsoft sign-in) is on the roadmap.
 */
